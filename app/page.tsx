...
export default function Home() {
  return (
    <Layout>
      ...
      <section id="features" className="bg-gray-50 py-16 dark:bg-gray-900 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
              Crafted with modern tooling, sensible defaults, and extensible patterns so you can focus on solving real
              customer problems.
            </p>
          </div>
            ...
            {tiers.map((tier) => (
              ...
              >
                ...
                <CardContent className="flex flex-1 flex-col justify-between">
                  <div>
                    <p className="text-3xl font-bold text-gray-900 dark:text-white">{tier.price}</p>
      ...
      <section className="bg-gray-900 py-16 text-white sm:py-24">
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Ready to launch your next idea?</h2>
          <p className="mt-4 text-lg text-gray-300">
            Base App gives you a polished foundation with authentication, data access, and deployment built in. Connect your
            domain, ship features, and focus on your customers.
          </p>
